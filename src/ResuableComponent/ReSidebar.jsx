...
//   return (
//     <div className="lg:h-[517px] lg:w-[331px] sm:w-full bg-[#0d2539] border-r-2 border-b-2 border-[#F3C15F] mt-[59px] px-[33px] sm:mt-0">
//       {/* Header */}
...
//             <a href={link.href} className="text-[20px] font-bold">
//               {link.label}
//             </a>
//           </li>
//         ))}
