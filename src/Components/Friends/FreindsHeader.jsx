...
//       {/* Title Section */}
//       <div className="text-white text-xl sm:text-2xl md:text-2xl lg:text-[35px] xl:text-[45px] font-bold">
//         <h2>Friends (47)</h2>
//       </div>

//       {/* Status & Buttons */}
//       <div className="flex gap-x-4 items-center flex-wrap md:flex-wrap lg:gap-x-8">
//         {/* Online Status */}
...
//         {/* Grid Icons */}
//         <div className="flex items-center gap-x-2 sm:mt-2 md:mt-1">
